    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("bt_plan_id", models.CharField(blank=True, max_length=100, verbose_name="BrainTree Plan ID")),
                ("bt_plan_name", models.CharField(blank=True, max_length=200, verbose_name="BrainTree Plan Name")),
                ("description", models.TextField(blank=True, verbose_name="Description")),
                ("is_active", models.BooleanField(default=True, verbose_name="Active")),
